        ...
        case 'sets':
          result.sets.replace(serializers.deserialize(value,
              specifiedType: const FullType(
                  BuiltList, const [const FullType(PlannedSet)])) as BuiltList);
          break;
        case 'hasWeight':
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'sets':
          result.sets.replace(serializers.deserialize(value,
              specifiedType: const FullType(
                  BuiltList, const [const FullType(WorkoutSet)])) as BuiltList);
          break;
        case 'weight':
      ...
      switch (key) {
        ...
        case 'exercises':
          result.exercises.replace(serializers.deserialize(value,
              specifiedType: const FullType(
                  BuiltList, const [const FullType(Exercise)])) as BuiltList);
          break;
        case 'rotationIndex':
...
class _$Day extends Day {
  ...
  _$Day._({this.id, this.plannedExerciseIds}) : super._() {
    if (id == null) throw new BuiltValueNullFieldError('Day', 'id');
  ...
  bool operator ==(dynamic other) {
    ...
    return id == other.id && plannedExerciseIds == other.plannedExerciseIds;
  }
...
class _$PlannedExercise extends PlannedExercise {
  ...
  _$PlannedExercise._(
      ...
      this.decreaseFactor})
      : super._() {
    if (id == null) throw new BuiltValueNullFieldError('PlannedExercise', 'id');
    if (name == null)
  ...
  bool operator ==(dynamic other) {
    if (identical(other, this)) return true;
    if (other is! PlannedExercise) return false;
    return id == other.id &&
        name == other.name &&
        sets == other.sets &&
...
class _$PlannedSet extends PlannedSet {
  ...
  _$PlannedSet._({this.reps}) : super._() {
    if (reps == null) throw new BuiltValueNullFieldError('PlannedSet', 'reps');
  }
  ...
  bool operator ==(dynamic other) {
    if (identical(other, this)) return true;
    if (other is! PlannedSet) return false;
...
class _$WorkoutSet extends WorkoutSet {
  ...
  bool operator ==(dynamic other) {
    ...
    return plannedReps == other.plannedReps &&
...
class _$Exercise extends Exercise {
  ...
  _$Exercise._(
    ...
    if (sets == null) throw new BuiltValueNullFieldError('Exercise', 'sets');
    if (weight == null)
  ...
  bool operator ==(dynamic other) {
    ...
    return plannedExerciseId == other.plannedExerciseId &&
        sets == other.sets &&
        weight == other.weight &&
...
class _$Workout extends Workout {
  ...
  _$Workout._({this.date, this.exercises, this.rotationIndex}) : super._() {
    if (date == null) throw new BuiltValueNullFieldError('Workout', 'date');
    if (exercises == null)
